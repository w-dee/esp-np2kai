...
def canonical_lines() -> list[str]:
    ...
    return [
        "5D2_S1_IDENTITY schema=1 evidence_class=PHYSICAL_EXEC "
        ...
        "5D2_S1_START schema=1 evidence_class=PHYSICAL_EXEC rate_hz=48000 "
        ...
        "5D2_S1_PCM schema=1 evidence_class=PHYSICAL_EXEC "
        ...
        "5D2_S1_FINISH schema=1 evidence_class=PHYSICAL_EXEC "
        "controller_state=FINISHED sink_state=QUIESCENT "
        "final_copy_eof_epoch=4294967294 finish_eof_epoch=2 "
        "post_snapshot_eofs=4 drain_duration_ms=4 finish_completed=1 "
...
def main() -> int:
    ...
    mutations.append(("unknown_record", canonical[:1] +
                      ["5D2_S1_UNKNOWN schema=1 evidence_class=PHYSICAL_EXEC"] +
                      canonical[1:]))
