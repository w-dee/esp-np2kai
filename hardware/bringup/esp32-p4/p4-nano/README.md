...
Status: **MEASURED ON REAL HARDWARE: SOFTWARE/UART PASS; LED BLINK PASS**
...
The first GPIO20 bring-up diagnostic is complete. Further diagnostics, such
as PSRAM, SD/MMC, MIPI-DSI, USB host, audio, and production firmware tests,
