...
/*
 * Project-owned adaptation of Waveshare esp_lcd_jd9365_10_1 1.0.4.
 * The upstream constructor's hidden display-side I2C/backlight block is
 * intentionally removed. Backlight policy is owned by main.c.
 */
