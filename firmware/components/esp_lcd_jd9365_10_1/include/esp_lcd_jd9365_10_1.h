...
/* The registry package normally supplies these through package_manager.  The
 * production foundation keeps the pinned 1.0.4 header surface locally for
 * offline/reproducible builds, so provide the equivalent version constants. */
#ifndef ESP_LCD_JD9365_10_1_VER_MAJOR
#define ESP_LCD_JD9365_10_1_VER_MAJOR 1
#define ESP_LCD_JD9365_10_1_VER_MINOR 0
#define ESP_LCD_JD9365_10_1_VER_PATCH 4
#endif
